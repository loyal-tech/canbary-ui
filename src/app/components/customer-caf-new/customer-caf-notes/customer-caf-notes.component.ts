...
@Component({
  selector: "app-customer-caf-notes",
  templateUrl: "./customer-caf-notes.component.html",
  styleUrls: ["./customer-caf-notes.component.css"]
})
export class CustomerCafNotesComponent implements OnInit {
  customerId = 0;
  custType: string = "";
  currentPage = 1;
